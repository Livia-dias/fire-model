...
acuracia_apa= "modelo_topográfico\\APA Cavernas\\resultados\\modelo_acuracia_lasso_cave.csv"
...
#confusion matrix
tabela=table(pred=lasso_predict,true=dados_teste_cave_lasso$HAS_FIRE)
write.csv(tabela, acuracia_apa)
#accuracy
